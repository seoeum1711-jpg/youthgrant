...
export function PublicFooter(){
  ...
  return <footer className="public-footer">
    <div className="public-footer-inner">
      ...
      <div className="footer-note"><p>YouthGrant는 지원정보 탐색을 돕기 위한 서비스입니다. 최종 신청 자격·일정·조건은 주관기관의 공식 공고를 확인해 주세요.</p><DataPrincipleDialog triggerClassName="footer-principle-trigger"/></div>
