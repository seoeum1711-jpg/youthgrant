...
export const sourceRegistry:SourceDefinition[]=[
  ...
  {id:"ggyouth",name:"경기도청소년활동진흥센터",method:"WEB",region:"경기",url:"https://ggyouth.or.kr/07_openYard/noticeList.do",implemented:true,health:"GREEN"},
  {id:"ggyouthnet",name:"경기도청소년수련시설협회",method:"WEB",region:"경기",url:"https://ggyouthnet.or.kr/bbs/board.php?bo_table=notice_n",implemented:true,health:"GREEN"},
  {id:"hswf",name:"화성시여성가족청소년재단",method:"WEB",region:"경기",url:"https://www.hswf.or.kr/",implemented:false,health:"YELLOW"},
  {id:"kywa",name:"한국청소년활동진흥원",method:"WEB",region:"전국",url:"https://www.kywa.or.kr/pressinfo/notice_list.jsp",implemented:true,health:"GREEN"},
  ...
  {id:"seoul_city",name:"서울특별시 고시·공고",method:"RSS",region:"서울",url:"https://seoulboard.seoul.go.kr/rss/RSSGenerator?bbsNo=277",implemented:true,health:"GREEN"},
  {id:"seoul_news_api",name:"서울시 열린데이터광장 새소식",method:"API",region:"서울",url:"http://openapi.seoul.go.kr:8088",implemented:true,health:"YELLOW"},
